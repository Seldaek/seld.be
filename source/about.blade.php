...
@section('body')
    ...
    <p class="mb-6">My time spent on open source is sponsored by <a href="https://packagist.com">Private Packagist</a> as well as my lovely <a href="https://github.com/sponsors/Seldaek">GitHub sponsors</a>.</p>
@endsection
